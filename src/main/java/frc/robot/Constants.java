...
public final class Constants {
  ...
  public static final class Cameras {
    ...
    // Robot frame: +X is forward, +Y is left, and +Z is up.  The 27 in. square
    // chassis puts its side edges at Y = +/-13.5 in.; both cameras are 9 in.
    // behind the front edge, 7.25 in. above the floor, and tilt 10 deg upward.
    public static final CameraConfig[] ALL = {
      new CameraConfig(
          ...
          new SimCameraProperties() {
            {
              setCalibration(1280, 800, Rotation2d.fromDegrees(120.0));
